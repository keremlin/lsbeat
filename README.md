...
```
git remote set-url origin https://github.com/keremlin/lsbeat
...
```
mkdir -p ${GOPATH}/github.com/keremlin
cd ${GOPATH}/github.com/keremlin
git clone https://github.com/keremlin/lsbeat
```
